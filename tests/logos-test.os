...
Процедура Тест_ДолженПроверитьЧтоАппендерУстановлен() Экспорт
	...
	Утверждения.ПроверитьРавенство("ИНФОРМАЦИЯ - [logos.internal] - " + "Привет", мСообщенияЛога[0]);
КонецПроцедуры
...
Процедура Тест_ДолженПроверитьВыводБолееПриоритетногоСообщения() Экспорт
	...
	Утверждения.ПроверитьРавенство("ИНФОРМАЦИЯ - [logos.internal] - " + "Привет", мСообщенияЛога[0]);
	Утверждения.ПроверитьРавенство("ОШИБКА - [logos.internal] - " + "Ошибка", мСообщенияЛога[1]);
...
Процедура Тест_ДолженПроверитьЧтоНеВыводятсяМенееПриоритетныеСообщения() Экспорт
	...
	Утверждения.ПроверитьРавенство("ОШИБКА - [logos.internal] - " + "Ошибка", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводПредупреждения() Экспорт
	...
	Утверждения.ПроверитьРавенство("ПРЕДУПРЕЖДЕНИЕ - [logos.internal] - " + "Привет", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводОшибки() Экспорт
	...
	Лог.УстановитьУровень(УровниЛога.Ошибка);
	Лог.Ошибка("Привет");
	Утверждения.ПроверитьРавенство("ОШИБКА - [logos.internal] - " + "Привет", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводКритичнойОшибки() Экспорт
	...
	Утверждения.ПроверитьРавенство("КРИТИЧНАЯОШИБКА - [logos.internal] - " + "Привет", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводИнформацииЧерезСтрШаблон() Экспорт
	...
	Утверждения.ПроверитьРавенство("ИНФОРМАЦИЯ - [logos.internal] - " + "Привет Первый,Второй", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводПредупрежденияЧерезСтрШаблон() Экспорт
	...
	Утверждения.ПроверитьРавенство("ПРЕДУПРЕЖДЕНИЕ - [logos.internal] - " + "Привет Первый,Второй", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводОшибкиЧерезСтрШаблон() Экспорт
	...
	Утверждения.ПроверитьРавенство("ОШИБКА - [logos.internal] - " + "Привет Первый,Второй", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьВыводКритичнойОшибкиЧерезСтрШаблон() Экспорт
	...
	Утверждения.ПроверитьРавенство("КРИТИЧНАЯОШИБКА - [logos.internal] - " + "Привет Первый,Второй", мСообщенияЛога[0]);
...
Процедура Тест_ДолженВывестиВЛогПростуюСтрокуСПустымПараметром() Экспорт
	...
	Утверждения.ПроверитьРавенство("ИНФОРМАЦИЯ - [logos.internal] - Привет <%1>", мСообщенияЛога[0]);
...
Процедура Тест_ДолженПроверитьНастройкуРазныхУровнейУРазныхСпособовВывода() Экспорт
	...
	Ожидаем.Что(Сообщения2[0], "ВторойСпособВывода 0").Равно("ПРЕДУПРЕЖДЕНИЕ - [testlog] - "+"Внимание");
КонецПроцедуры
...
Процедура Тест_ДолженПроверитьСокращениеИмениЛогаПриВыводеСообщения() Экспорт
	...
	Для Каждого ДанныеЛога Из ИменаЛогов Цикл
		...
		Лог.ДобавитьСпособВывода(ЭтотОбъект, УровниЛога.Информация);
		...
		ОжидаемаяСтрока = СтрШаблон("ИНФОРМАЦИЯ - [%1] - Привет", ДанныеЛога.Значение);
