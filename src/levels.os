...
Процедура ИнициализироватьУровни()
	...
	// мУровниПриоритета = СоздатьУровниСПриоритетами();
...
// Функция СоздатьУровниСПриоритетами()

// 	Результат = Новый Структура;
// 	Результат.Вставить("Отладка"        , 0);
// 	Результат.Вставить("Информация"     , 1);
// 	Результат.Вставить("Предупреждение" , 2);
// 	Результат.Вставить("Ошибка"         , 3);
// 	Результат.Вставить("КритичнаяОшибка", 4);
// 	Результат.Вставить("Отключить"      , 5);
