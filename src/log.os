...
Функция ЕстьЗаполненыеПараметры(Знач Параметр1 = Неопределено, Знач Параметр2 = Неопределено, Знач Параметр3 = Неопределено,
	...
	Если НЕ (Параметр1 = Неопределено
	   И Параметр2 = Неопределено
	   И Параметр3 = Неопределено
	   И Параметр4 = Неопределено
	   И Параметр5 = Неопределено
	   И Параметр6 = Неопределено
	   И Параметр7 = Неопределено
	   И Параметр8 = Неопределено
	   И Параметр9 = Неопределено) Тогда
		Возврат Истина;
	КонецЕсли;
