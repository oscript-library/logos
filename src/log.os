...
Функция ПолучитьРаскладку() Экспорт
	Возврат мРаскладкаСообщения;
КонецФункции
...
Процедура Вывести(Знач Сообщение, Знач УровеньСообщения,
	...
	Если УровеньСообщения >= Уровень() Тогда
		Для Каждого СпособВывода Из мСпособыВывода Цикл
			...
			Попытка
				форматированноеСообщение = мРаскладкаСообщения.Форматировать(УровеньСообщения, Сообщение, СтандартнаяОбработка);
			Исключение
				// Обратная совместимость
				форматированноеСообщение = мРаскладкаСообщения.Форматировать(УровеньСообщения, Сообщение);
			КонецПопытки;

			Если СтандартнаяОбработка Тогда
				СпособВывода.Вывести( форматированноеСообщение );
			КонецЕсли;
